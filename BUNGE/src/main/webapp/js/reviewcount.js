$(function() {
	$.ajax({
            ...
            $(rdata.boardlist).each(function(index, item) {
                ...
                output += "<div class='board_subject'><a href='InfoDetail.com?inf_num=" + item.board.inf_num + "'>";
                output += "<h3 class='board_inf_subject_title'>제목 : " + item.board.inf_subject + "</h3></a></div>";
                output += "<div class='board_content'><p class='board_inf_contet_text'>내용 :" + item.board.inf_content + "</p></div>";
                output += "</div>";
                output += "<div class='board_img'><div class='img'><img src='" + item.board.inf_cover + "'></div></div>";
                output += "</div>";
                output += "<div class='like_comm_box'>";
                output += "<div class='inf_like_num'>";
                output += "<img src='./image/like_on.png'><span class='likecnt'>" + likecount + "</span>";
                output += "</div>";
                output += "<div class='inf_comm_num'>";
                output += "<img width='50px' height='50px' alt='talk' src='./image/talk.jpg'><span class='commcnt'></span>";
                output += "</div>";
                output += "</div>";
                output += "</div>";
                output += "</div>";
